...
func (p *OpenAIProvider) removeAnthropicSpecificFields(request map[string]interface{}) map[string]interface{} {
...
func (p *OpenAIProvider) removeFieldsRecursively(data interface{}, fieldsToRemove []string) interface{} {
	switch v := data.(type) {
...
func (p *OpenAIProvider) transformTools(tools []interface{}) ([]interface{}, error) {
	return TransformTools(tools)
}

func (p *OpenAIProvider) transformMessages(messages []interface{}) []interface{} {
...
func (p *OpenAIProvider) extractToolResults(content []interface{}) []interface{} {
...
func (p *OpenAIProvider) transformAssistantMessage(msgMap map[string]interface{}, content []interface{}) map[string]interface{} {
